...
describe('DrawerFooter component', () => {
	...
	it('applies custom classes', () => {
		const { getByTestId } = render(<DrawerFooter className="custom-class" data-testid="drawer-footer" />)
		const drawerFooter = getByTestId('drawer-footer')
		expect(drawerFooter).toHaveClass('custom-class')
	})

	it('applies custom props', () => {
		const { getByTestId } = render(<DrawerFooter data-testid="drawer-footer" id="test" />)
		const drawerFooter = getByTestId('drawer-footer')
