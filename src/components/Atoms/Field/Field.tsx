...
export const Field = forwardRef<HTMLInputElement, FieldProps>(({ isInvalid, className, rightIcon, ...props }, ref) => {
	return (
		<div className={twMerge('relative w-full', props.disabled && 'pointer-events-none opacity-50')}>
			<input
				className={twMerge(
