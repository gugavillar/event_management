...
const generateLink = (type: MEMBERS) => {
	const label = type === MEMBERS.PARTICIPANT ? 'termo de participação' : 'termo de voluntariado'
	const link = type === MEMBERS.PARTICIPANT ? '/terms/termo-participantes.pdf' : '/terms/termo-voluntarios.pdf'
	return (
