...
export const TransactionSchema = z.object({
	...
	amountType: z
		...
		.refine((value) =>
			[TransactionAmountType.ACCOUNT, TransactionAmountType.CASH].includes(value as TransactionAmountType)
		),
	date: z
	...
	type: z
		...
		.refine((value) => [TransactionsType.INCOME, TransactionsType.OUTCOME].includes(value as TransactionsType), {
			error: 'Campo obrigatório',
		}),
})
