...
export const AgesChart = ({ categories, series, isLoading }: ChartValidationProps) => {
	return (
		<ChartContainer headingText="Faixa etária" subheadingText="Quantitativo por faixa etária">
