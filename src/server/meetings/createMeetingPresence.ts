...
export const normalizeAttendanceData = (input: AttendanceInput): NormalizedAttendance[] => {
...
export const createMeetingPresence = async (data: MeetingPresenceRouteType, updatePresence: boolean) => {
	try {
