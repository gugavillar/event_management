...
export const ENDPOINTS = {
	...
	DELETE_FUNCTION: (function_id: string) => `${BASE_PATH.VOLUNTEERS}/functions/${function_id}`,
	DELETE_GROUP: (group_id: string) => `${BASE_PATH.GROUPS}/group/${group_id}`,
	DELETE_PARTICIPANT: (participant_id: string) => `${BASE_PATH.PARTICIPANTS}/${participant_id}`,
	DELETE_ROOM: (room_id: string) => `${BASE_PATH.ROOMS}/room/${room_id}`,
	DELETE_TRANSACTION: (transaction_id: string) => `${BASE_PATH.TRANSACTIONS}/${transaction_id}`,
	DELETE_VOLUNTEER: (volunteer_id: string) => `${BASE_PATH.VOLUNTEERS}/${volunteer_id}`,
	...
	GET_GROUP_BY_EVENT_ID: (event_id: string) => `${BASE_PATH.GROUPS}/events/${event_id}`,
	...
	UPDATE_FUNCTION: (function_id: string) => `${BASE_PATH.VOLUNTEERS}/functions/${function_id}`,
	UPDATE_GROUP: (group_id: string) => `${BASE_PATH.GROUPS}/group/${group_id}`,
	UPDATE_INTERESTED_EVENT: (event_id: string) => `${BASE_PATH.EVENTS}/${event_id}/interested`,
	UPDATE_INTERESTED_PARTICIPANT: (participant_id: string) => `${BASE_PATH.PARTICIPANTS}/${participant_id}/interested`,
	UPDATE_PARTICIPANT: (participant_id: string) => `${BASE_PATH.PARTICIPANTS}/${participant_id}`,
	UPDATE_REGISTRATION_EVENT: (event_id: string) => `${BASE_PATH.EVENTS}/${event_id}/registration`,
